...
import { DataLabelGolongan } from "./data/tabelGolongan";
import { setContentType, setSelectedId } from "Configs/Redux/reducers";
import { useEffect, useState } from "react"
import { useDispatch, useSelector } from "react-redux";
import { toast } from "react-toastify";
import { GetAllPageGolongan, DeleteDataGolongan } from "Services/Pengaturan";
...
export const Golongan = () => {
    ...
    const fetchAllData = async (value) => {
        try {
            const response = await GetAllPageGolongan({page: value, perpage: 10});
    ...
    const deleteData = async () => {
        try {
            const response = await DeleteDataGolongan(state.selectedId);
            if (response.data) {
                fetchAllData(1);
    ...
    return (
        <main>
            ...
            <Content 
                ...
                listContentTab={DataLabelGolongan}
