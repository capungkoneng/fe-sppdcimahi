...
import { DataLabelSewaKendaraan } from "./data/tabelSewaKendaraan";
...
export const SewaKendaraan = () => {
    ...
    return (
        <main>
            ...
            /> */}
            <SectionHeader 
                title="Biaya Sewa Kendaraan" 
                icon={ iconTitle() }
                count={ listData.length }
            />
            <Content 
                content="Biaya Sewa Kendaraan"
                data={listData}
                // listTabData={DataTabsSupplier}
                listContentTab={DataLabelSewaKendaraan}
                    ...
                    return value.length === 0 ? (
                        ...
                        return (
                            <tr key={index}>
                                ...
                                <TableContent>{formatterCurrency.format(parseInt(result.roda4))}</TableContent>
                                <TableContent>{formatterCurrency.format(parseInt(result.roda6_biskecil))}</TableContent>
                                <TableContent>{formatterCurrency.format(parseInt(result.roda6_bisbesar))}</TableContent>
                                <TableContent>{formatterCurrency.format(parseInt(result.taxi))}</TableContent>
