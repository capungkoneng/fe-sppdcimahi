...
import { DataLabelPenginapan } from "./data/tabelPenginapan";
    ...
    return (
        <main>
            ...
            <Content 
                ...
                listContentTab={DataLabelPenginapan}
                    ...
                    return value.length === 0 ? (
                        ...
                        return (
                            <tr key={index}>
                                ...
                                <TableContent>{ formatterCurrency.format(parseInt(result.peselon1)) }</TableContent>
                                <TableContent>{ formatterCurrency.format(parseInt(result.peselon2)) }</TableContent>
                                <TableContent>{ formatterCurrency.format(parseInt(result.g2eselon1)) }</TableContent>
                                <TableContent>{ formatterCurrency.format(parseInt(result.g3eselon3)) }</TableContent>
                                <TableContent>{ formatterCurrency.format(parseInt(result.g4eselon4)) }</TableContent>
