...
import { DataLabelRapatLuarKantor } from "./data/tabelRapatLuarKantor";
...
export const RapatLuarKantor = () => {
    ...
    return (
        <main>
            ...
            /> */}
            <SectionHeader 
                title="Biaya Rapat Luar Kantor" 
                icon={ iconTitle() }
                count={ listData.length }
            />
            <Content 
                content="Biaya Rapat Luar Kantor"
                data={listData}
                // listTabData={DataTabsSupplier}
                listContentTab={DataLabelRapatLuarKantor}
                    ...
                    return value.length === 0 ? (
                        ...
                        return (
                            <tr key={index}>
                                ...
                                <TableContent>{formatterCurrency.format(parseInt(result.fullboard_luarkota))}</TableContent>
                                <TableContent>{formatterCurrency.format(parseInt(result.fullboard_dalemkota))}</TableContent>
                                <TableContent>{formatterCurrency.format(parseInt(result.fullday))}</TableContent>
