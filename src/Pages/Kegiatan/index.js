            ...
            <Content 
                ...
                renderContent={(value) => {
                    return value.length === 0 ? (
                        ...
                        return (
                            <tr key={index}>
                                <TableContent className={`${index === value.length - 1 ? 'rounded-bl-lg' : '' } ${result.status === '0' ? 'bg-gray-400' : result.status === '1' ? 'bg-blue-400' : result.status === '2' ? 'bg-yellow-200' : 'bg-green-200'} align-text-top text-justify w-[30%]`}>{ result.keperluan }</TableContent>
                                <TableContent className={`${result.status === '0' ? 'bg-gray-400' : result.status === '1' ? 'bg-blue-400' : result.status === '2' ? 'bg-yellow-200' : 'bg-green-200'} align-text-top`}>{ result.no_surat }</TableContent>
                                <TableContent className={`${result.status === '0' ? 'bg-gray-400' : result.status === '1' ? 'bg-blue-400' : result.status === '2' ? 'bg-yellow-200' : 'bg-green-200'} align-text-top`}>{ result.lokasi }</TableContent>
                                <TableContent className={`${result.status === '0' ? 'bg-gray-400' : result.status === '1' ? 'bg-blue-400' : result.status === '2' ? 'bg-yellow-200' : 'bg-green-200'} align-text-top`}>{ moment(result.tgl_berangkat).format('DD-MMM-YYYY') }</TableContent>
                                <TableContent className={`${result.status === '0' ? 'bg-gray-400' : result.status === '1' ? 'bg-blue-400' : result.status === '2' ? 'bg-yellow-200' : 'bg-green-200'} align-text-top`}>{ moment(result.tgl_mulai).format('DD-MMM-YYYY') }</TableContent>
                                <TableContent className={`${result.status === '0' ? 'bg-gray-400' : result.status === '1' ? 'bg-blue-400' : result.status === '2' ? 'bg-yellow-200' : 'bg-green-200'} align-text-top`}>{ moment(result.tgl_selesai).format('DD-MMM-YYYY') }</TableContent>
                                <TableContent className={`gap-2 text-sm text-[#202020] px-6 py-4 whitespace-nowrap ${index === value.length - 1 ? 'rounded-br-lg' : '' } ${result.status === '0' ? 'bg-gray-400' : result.status === '1' ? 'bg-blue-400' : result.status === '2' ? 'bg-yellow-200' : 'bg-green-200'}`}>
                                    {
